/**
 * ML Wing FAQ Section
 * Same as the shared FAQ.jsx but WITHOUT the "Join our community" QR block.
 */
...
export default function MLFAQSection() {
  ...
  return (
    <section id="faq" className="relative bg-white py-20 md:py-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* "Join our community" QR section intentionally removed for ML wing */}
      </div>
    </section>
  );
}
