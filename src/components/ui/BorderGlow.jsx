...
const BorderGlow = ({
  ...
  const isVisible = alwaysActive || isHovered || sweepActive;
  const borderOpacity = alwaysActive ? 1 : (isVisible
    ? Math.max(0, (edgeProximity * 100 - colorSensitivity) / (100 - colorSensitivity))
    : 0);
  const glowOpacity = alwaysActive ? 1 : (isVisible
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          mixBlendMode: blendMode === 'plus-lighter' ? 'soft-light' : 'normal',
          transition: isVisible ? 'opacity 0.25s ease-out' : 'opacity 0.75s ease-in-out',
        }}
      />
