export const eventsData = [
  {
    id: "4",
    title: "Hackvotrix",
    poster: "/poster/hackvotrix.png",
    time: "September-12, 2025 - 09:00 AM",
    venue: "AI BLOCK",
    status: "register",
    registrationLink: "https://forms.gle/GcZpJQd2c6uWQMBa6",
    description:
  ...
  },
  {
    ...
    how:
      "Thinkathon immerses participants in a fast-paced environment where they collaborate with peers to tackle problems in AI. Teams are challenged to work on tasks such as model development, deployment, dataset training, and building AI agents. By combining innovation with practical implementation, Thinkathon provides students with the opportunity to strengthen their problem-solving abilities while gaining hands-on experience in modern AI workflows.",
  photos: ["/thinkathon/thinkathon(1).jpg", "/thinkathon/thinkathon(2).jpg","/thinkathon/thinkathon(3).jpg","/thinkathon/thinkathon(4).jpg","/thinkathon/thinkathon(5).jpg"]
  },
  {
    id: "3",
    title: "Workshop",
    poster: "/poster/workshop.png",
    ...
    photos: ["/workshop/workshop(1).jpg", "/workshop/workshop(2).jpg", "/workshop/workshop(3).jpg", "/workshop/workshop(4).jpg", "/workshop/workshop(5).jpg"]
  },
  {
    id: "1",
    title: "HCS",
    poster: "/poster/hcs.png",
    venue: "AI BLOCK",
    time:"",
    status: "upcoming",
    registrationLink: "https://example.com/register/techfest",
  ...
  photos: ["/hcs/HCS1(1).jpeg", "/hcs/HCS1(2).jpeg", "/hcs/HCS1(3).jpeg", "/hcs/HCS1(4).jpg"]
  },
  {
    id: "6",
    title: "Hacksphere",
    poster: "/poster/hacksphere1.png",
  ...
  photos: ["/poster/placement_talks1.png", "/poster/placement_talks.png"]
  }
